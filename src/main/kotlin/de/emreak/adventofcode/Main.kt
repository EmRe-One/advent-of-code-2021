...
fun solveDay20() {
    val input = AdventOfCodeUtils.readLines(filename = "day20.txt")
...
fun solveDay21() {
    val input = AdventOfCodeUtils.readLines(filename = "day21.txt")
...
fun solveDay22() {
    val input = AdventOfCodeUtils.readLines(filename = "day22.txt")
...
fun solveDay23() {
    val input = AdventOfCodeUtils.readLines(filename = "day23.txt")
...
fun solveDay24() {
    val input = AdventOfCodeUtils.readLines(filename = "day24.txt")
...
fun solveDay25() {
    val input = AdventOfCodeUtils.readLines(filename = "day25.txt")
